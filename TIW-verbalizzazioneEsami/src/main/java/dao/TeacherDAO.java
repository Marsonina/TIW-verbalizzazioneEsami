...
public class TeacherDAO {
	...
	public List<Course> getCourses() throws SQLException {
		...
		String query = "SELECT id, name FROM course WHERE matricolaTeacher = ?";
	...
	public List<Exam> getExamDates(int chosenCourseId) throws SQLException {
		...
		String query = "SELECT date FROM course, exam WHERE courseId = id AND courseId = ? AND matricolaTeacher = ?";
		try (PreparedStatement pstatement = connection.prepareStatement(query);) {
